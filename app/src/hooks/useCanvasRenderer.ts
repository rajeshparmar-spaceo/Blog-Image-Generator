...
export function useCanvasRenderer(canvasRef: RefObject<HTMLCanvasElement | null>) {
  ...
  useEffect(() => {
    ...
    state.soaHeadlineWidth, state.soaSubtitleWidth,
    state.socHeadlineWidth, state.socSubtitleWidth,
    state.soiHeadlineWidth, state.soiSubtitleWidth,
    state.taskRhinoHeadlineWidth, state.taskRhinoSubtitleWidth,
    state.welcoHeadlineWidth, state.welcoSubtitleWidth,
