...
export const useEditorStore = create<Store>((set) => ({
  ...
  soaHeadlineWidth: 270,
  soaSubtitleWidth: 270,
  socHeadlineWidth: 420,
  socSubtitleWidth: 420,
  soiHeadlineWidth: 270,
  soiSubtitleWidth: 270,
  taskRhinoHeadlineWidth: 540,
  taskRhinoSubtitleWidth: 540,
  welcoHeadlineWidth: 650,
  welcoSubtitleWidth: 600,
  cbBgColor: '#FFFFFF',
  cbBgColor2: '#F8F4F0',
  ...
  setSoaHeadlineWidth: (soaHeadlineWidth) => set({ soaHeadlineWidth }),
  setSoaSubtitleWidth: (soaSubtitleWidth) => set({ soaSubtitleWidth }),
  setSocHeadlineWidth: (socHeadlineWidth) => set({ socHeadlineWidth }),
  setSocSubtitleWidth: (socSubtitleWidth) => set({ socSubtitleWidth }),
  setSoiHeadlineWidth: (soiHeadlineWidth) => set({ soiHeadlineWidth }),
  setSoiSubtitleWidth: (soiSubtitleWidth) => set({ soiSubtitleWidth }),
  setTaskRhinoHeadlineWidth: (taskRhinoHeadlineWidth) => set({ taskRhinoHeadlineWidth }),
  setTaskRhinoSubtitleWidth: (taskRhinoSubtitleWidth) => set({ taskRhinoSubtitleWidth }),
  setWelcoHeadlineWidth: (welcoHeadlineWidth) => set({ welcoHeadlineWidth }),
  setWelcoSubtitleWidth: (welcoSubtitleWidth) => set({ welcoSubtitleWidth }),
