...
export interface EditorState {
  ...
  soaHeadlineWidth: number;
  soaSubtitleWidth: number;
  socHeadlineWidth: number;
  socSubtitleWidth: number;
  soiHeadlineWidth: number;
  soiSubtitleWidth: number;
  taskRhinoHeadlineWidth: number;
  taskRhinoSubtitleWidth: number;
  welcoHeadlineWidth: number;
  welcoSubtitleWidth: number;
  cbBgColor: string;
  cbBgColor2: string;
...
export interface EditorActions {
  ...
  setSoaHeadlineWidth: (w: number) => void;
  setSoaSubtitleWidth: (w: number) => void;
  setSocHeadlineWidth: (w: number) => void;
  setSocSubtitleWidth: (w: number) => void;
  setSoiHeadlineWidth: (w: number) => void;
  setSoiSubtitleWidth: (w: number) => void;
  setTaskRhinoHeadlineWidth: (w: number) => void;
  setTaskRhinoSubtitleWidth: (w: number) => void;
  setWelcoHeadlineWidth: (w: number) => void;
  setWelcoSubtitleWidth: (w: number) => void;
